...
```
    ...
    ## 1 1033  Narges Mo… female 2023      Peace    Zanjan    Iran         Zanjan  Iran      
    ## 2 773   Shirin Eb… female 2003      Peace    Hamadan   Iran         Hamadan Iran      
...
```
    ...
    ##   id    fullName   gender awardYear category birthCity birthCountry cityNow countryNow
    ##   <chr> <chr>      <chr>  <chr>     <chr>    <chr>     <chr>        <chr>   <chr>     
    ## 1 967   Nadia Mur… female 2018      Peace    Kojo      Iraq         Kojo    Iraq      
    ## # ℹ 2 more variables: continent <chr>, locationString <chr>
